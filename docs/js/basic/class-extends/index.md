...
- 我们在构造函数的显示原型上，添加了`money`属性和`getDoubleMoney`方法
...
1. 创建一个空对象
2. 这个空对象的隐式原型`[[prototype]]`，等于父类的显示原型
3. 最后返回这个对象
...
![b58117e53b0147e79115fad4fa0a99d8_tplv-k3u1fbpfcp-zoom-in-crop-mark_3024_0_0_0.webp](./images/7.png)
